...
const SECTIONS: LegalSection[] = [
  {
    heading: "Giới thiệu",
    body: [
      "Website noi-that-minh-lam là kênh giới thiệu sản phẩm và tiếp nhận yêu cầu tư vấn của chúng tôi. Website không phải sàn thương mại điện tử — mọi đơn hàng được xác nhận và giao dịch trực tiếp qua Zalo, điện thoại hoặc tại showroom.",
  ...
  },
  {
    ...
    body: [
      ...
      "Giá cuối cùng (gồm VAT, vận chuyển, lắp đặt hoặc kích thước tuỳ chỉnh) sẽ được chúng tôi báo chính xác qua Zalo/điện thoại trước khi bạn xác nhận đặt hàng.",
    ],
  },
  {
    ...
    body: [
      ...
      "Đơn tuỳ chỉnh đã vào sản xuất không hỗ trợ huỷ/hoàn cọc, trừ trường hợp lỗi thuộc về chúng tôi.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      "Toàn bộ nội dung, hình ảnh thiết kế và tên sản phẩm trên website thuộc quyền sở hữu của chúng tôi. Vui lòng không sao chép, sử dụng cho mục đích thương mại khi chưa có chấp thuận bằng văn bản.",
    ],
  },
  {
    heading: "Liên hệ",
...
export default function Terms() {
  return (
    <LegalPage
      ...
      updated="01/07/2026"
      intro="Các điều khoản dưới đây điều chỉnh việc sử dụng website của chúng tôi và quy trình tư vấn, đặt hàng qua Zalo/điện thoại. Vui lòng đọc kỹ trước khi gửi yêu cầu tư vấn hoặc đặt hàng."
      sections={SECTIONS}
    />
  );
}
