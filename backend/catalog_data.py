...
PRODUCTS = [
    ...
    {"id": "hp-dc02", "name": "Đèn Mây Tre Trang Trí DC02", "category": "decor-phu-kien", "price": 2600000, "price_display": "2.600.000 ₫", "wood_type": "Mây tre đan thủ công", "dimensions": "Ø400 x Cao 450 mm", "description": "Phụ kiện tuyển chọn tại cửa hàng của chúng tôi. Đèn thả mây tre đan tay, ánh sáng xuyên nan tạo vệt bóng mềm ấm cúng.", "badge": "Thủ công", "featured": False, "images": [_IMG["dc02"], _IMG["decor2"]]},
    ...
    {"id": "hp-dc04", "name": "Tủ Ngăn Kéo Trang Trí DC04", "category": "decor-phu-kien", "price": 12500000, "price_display": "12.500.000 ₫", "wood_type": "Gỗ công nghiệp phủ veneer sồi", "dimensions": "1200 x 450 x 850 mm", "description": "Phụ kiện tuyển chọn tại cửa hàng của chúng tôi. Tủ 6 ngăn kéo ray giảm chấn, mặt gỗ sáng màu, đa dụng phòng khách lẫn phòng ngủ.", "badge": "Độc quyền", "featured": True, "images": [_IMG["dc04"], _IMG["decor2"], _IMG["chest"]]},
